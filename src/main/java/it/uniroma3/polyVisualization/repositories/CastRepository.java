...
public class CastRepository {
	...
	private static final String QUERY = "SELECT * FROM moviecredits, credits, actors "
			+ "WHERE credits.id_actor = actors.id_actor AND moviecredits.id_credit = credits.id_credit "
			+ "AND moviecredits.id_movie = '";
